  ...
  const [reviews, setReviews] = useState<Review[]>([
    {
      ...
      rating: 5,
      comment: 'Brand Boosters transformed our edit flow. Their pacing structure raised our 30-second retention rate from 40% to 68%. Color grading is cinematic and consistent.',
      date: 'June 2, 2026',
      avatarInitials: 'MT',
      metric: '+70% Retention'
    },
